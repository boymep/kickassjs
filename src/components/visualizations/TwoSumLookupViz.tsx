...
const steps: Step[] = [
  {
    ...
    description: 'i=0, num=2, complement=7, Map пуст → добавляем {2: 0}',
  },
  {
    currentIdx: 1,
    num: 7,
    ...
    description: 'i=1, num=7, complement=2, Map.has(2) = true → Найдено! [0, 1]',
  },
];
...
const TwoSumLookupViz: React.FC = () => {
    ...
    >
      ...
      >
        ...
        {step.mapEntries.map((entry, i) => {
          ...
          const isHighlight = step.found && entry.key === step.complement;
...
export default TwoSumLookupViz;

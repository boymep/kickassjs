...

    {
      ...
      blocks: [
        ...
        },
        {
          type: 'text',
          content:
            'Камера наблюдения в магазине: вы видите что клиент делал — куда тыкал, где завис, что вводил — но не знаете кто он. Проблема в том, что без маскировки в эту «камеру» попадают номера карт, пароли, персональные данные — и это прямое нарушение GDPR и 152-ФЗ. Правильная настройка session replay — privacy-first по умолчанию: маскировать все input-поля, отключать запись на страницах с PII, и включать replay только при возникновении ошибки. На собеседовании tradeoff — privacy vs debugging: чем меньше данных пишете, тем сложнее дебажить; ответ — сэмплирование на ошибках, а не полная запись всех сессий.',
        },
        {
          type: 'callout',
          calloutType: 'warning',

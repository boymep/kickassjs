...
logWithContext('info', 'checkout-started', { userId: 'u_42', cartTotal: 1290 });`,
      ...
      video: {
        ...
        language: 'en',
        durationSec: 3 * 60,
        description: 'Charity Majors: observability как способность отвечать на новые вопросы без выкатки кода. Лучшее введение за три минуты.',
      },
      links: [
        {
          url: 'https://opentelemetry.io/docs/concepts/observability-primer/',
...
- A/B-вариант и активные feature flags — корреляция «фича X → INP +30 мс».`,
      ...
      video: {
        ...
        language: 'en',
        durationSec: 14 * 60,
        description: 'Как RUM-данные CrUX используются для ранжирования и как настроить web-vitals в проде.',
      },
      links: [
        {
          url: 'https://github.com/GoogleChrome/web-vitals',
...
- **scrubbing PII** в beforeSend — обязательный шаг по GDPR/152-ФЗ.`,
      ...
      video: {
        ...
        language: 'en',
        durationSec: 10 * 60,
        description: 'Официальный обзор Sentry: error tracking, source maps, performance, release tracking.',
      },
      links: [
        {
          url: 'https://docs.sentry.io/platforms/javascript/sourcemaps/',
          ...
          source: 'article',
          language: 'en',
          note: 'Как загружать source maps как артефакты релиза и не утечь исходники в браузер.',
        },
      ],
    },
...
- Регулярно проводите alert review: удаляйте те, по которым никто не действовал за квартал.`,
      ...
      video: {
        ...
        language: 'en',
        durationSec: 30 * 60,
        description: 'Charity Majors: чем observability отличается от monitoring и почему «wide events» важнее красивых dashboards.',
      },
      links: [
        {
          url: 'https://web.dev/articles/vitals-measurement-getting-started',
          ...
          source: 'web-dev',
          language: 'en',
          note: 'Практический гайд по сбору Web Vitals в production через web-vitals библиотеку и Analytics.',
        },
      ],
    },

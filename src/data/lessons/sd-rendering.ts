...
export default async function Page() {
  ...
  return <List posts={posts} />;
      ...
      video: {
        ...
        language: 'en',
        durationSec: 30 * 60,
        description: 'Лучший обзорный доклад: Lydia Hallie сравнивает CSR, SSR, SSG, ISR, streaming, islands на одних диаграммах.',
      },
      links: [
        {
          url: 'https://www.patterns.dev/vanilla/rendering-patterns',
...
console.log(blogRevalidate, newsRevalidate);`,
      ...
      video: {
        ...
        language: 'en',
        durationSec: 18 * 60,
        description: 'Прикладной разбор четырёх стратегий на примерах Next.js App Router: директивы, revalidate, когда что выбирать.',
      },
      links: [
        {
          url: 'https://nextjs.org/docs/app/building-your-application/rendering',
      ...
      links: [
        {
          ...
          source: 'article',
          language: 'en',
          note: 'Официальная спецификация RSC: модель, ограничения, сериализация payload и как работает hydration.',
        },
      ],
    },
...
- RSC payload — это **не HTML**, а сериализованное виртуальное дерево с плейсхолдерами для Client Components.`,
      ...
      video: {
        ...
        language: 'en',
        durationSec: 30 * 60,
        description: 'Lee Robinson на живом проекте: чем RSC отличаются от SSR, Client/Server-границы и data fetching.',
      },
    },

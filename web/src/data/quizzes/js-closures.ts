...
console.log(f());`,
    ...
    },
    {
      ...
      id: "jsc-q4",
      description:
        "Заполните пропуск, чтобы функция memoize корректно кешировала результаты.",
...
f(3);`,
      steps: [
        ...
        {
          label: "f(8) — второй вызов",
          variables: { called: "true", result: "50", "fn вызвана": "нет" },
        },
        {
          label: "f(3) — третий вызов",
          variables: { called: "true", result: "50", "fn вызвана": "нет" },
        },
      ],
...
test();`,
    ...
    },
    {
      ...
      id: "jsc-q10",
      description:
        "Заполните пропуск, чтобы каждая итерация цикла создавала свою область видимости.",
...
console.log(alice.getInfo());`,
    ...
    },
    {
      ...
      id: "jsc-q12",
      description:
        "Какова сложность по памяти функции memoize при n уникальных вызовах?",
